package com.devarifkhan.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.devarifkhan.services.*.*(..))")
    ...
    @Around("@annotation(com.devarifkhan.interfaces.LogAspect)")
    ...
    @AfterThrowing(value = "execution(* com.devarifkhan.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.devarifkhan.services.*.*(..))",returning = "retVal")
